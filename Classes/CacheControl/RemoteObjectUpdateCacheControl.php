 ...
 */
class RemoteObjectUpdateCacheControl
{
    /**
     ...
     * @return bool
     */
    public function remoteObjectNeedsUpdate(array $fileInfo): bool
    {
     ...
     * @param int $fileUid
     */
    public function updateRemoteCacheDirectiveForFile(int $fileUid): void
    {
        try {
     ...
     */
    public function updateCacheControlDirectivesForRemoteObject(AbstractFile $file): void
    {
